...
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Name', N'IsSystem', N'Weight') AND [object_id] = OBJECT_ID(N'[ComputerSpec]'))
    SET IDENTITY_INSERT [ComputerSpec] ON;
INSERT INTO [ComputerSpec] ([Id], [Name], [IsSystem], [Weight])
VALUES (1, N'Machine 1', CAST(1 AS bit), N'8.1 kg'),
(2, N'Machine 2', CAST(1 AS bit), N'12 kg'),
(3, N'Machine 3', CAST(1 AS bit), N'16 lb'),
(4, N'Machine 4', CAST(1 AS bit), N'13.8 lb'),
(5, N'Machine 5', CAST(1 AS bit), N'7 kg'),
(6, N'Machine 6', CAST(1 AS bit), N'6 kg'),
(7, N'Machine 7', CAST(1 AS bit), N'15 lb'),
(8, N'Machine 8', CAST(1 AS bit), N'8 lb'),
(9, N'Machine 9', CAST(1 AS bit), N'9 kg'),
(10, N'Machine 10', CAST(1 AS bit), N'22 lb');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Name', N'IsSystem', N'Weight') AND [object_id] = OBJECT_ID(N'[ComputerSpec]'))
